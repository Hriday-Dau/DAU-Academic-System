...
@Controller
@RequestMapping("/admin/droponlyopen")
public class OpenDropOnlyController {
    ...
    @GetMapping
    public String opendroponlyfor(Model model){

        Long currTermId = TermRepo.findMaxTrmid();
        List<String> batches = BatchRepo.findBatchesByTrmId(currTermId);

        List<Object[]> bchSpl = OpenRegistrationService.getBatchSpl(batches,currTermId, "DropOnly");
        ...
        return "admin/dropOnlyOpenFor";
    }

    @PostMapping("/savedroponlydate")
    public String saveDropOnlyDate(
        ...
        if (bchIds == null || bchIds.isEmpty()) {
            ...
            return "redirect:/admin/droponlyopen";
        }
        ...
        Long currTermId = TermRepo.findMaxTrmid();
        OpenRegistrationService.saveRegistrationDate(startDate,endDate,currTermId,bchIds,"DropOnly");
        
        redirectAttributes.addFlashAttribute("success", "Drop-Only dates saved successfully!");
        return "redirect:/admin/droponlyopen";
    }
}